...
const XRayUploadPage = ({ onNavigate, symptomAnswers = {}, onLogout, user, language = 'en', toggleLanguage, darkMode, toggleTheme }) => {
      ...
      <div className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="mb-12 text-center animate-fade-in">
            <div className="inline-block px-4 py-2 bg-blue-50 dark:bg-blue-900/50 rounded-full mb-6">
              <span className="text-sm font-semibold text-blue-600 dark:text-blue-300">{currentT.step}</span>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-100 dark:border-gray-700 p-12 animate-scale transition-colors">
            {error && (
            ...
            {!preview ? (
              ...
              >
                <div className="w-24 h-24 bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-blue-900 dark:to-cyan-900 rounded-3xl flex items-center justify-center mx-auto mb-8">
                  <Upload className="w-12 h-12 text-blue-600 dark:text-blue-300" strokeWidth={2} />
                </div>
                ...
                <label className="inline-block">
                  <input
                    ...
                    className="hidden"
                  />
                  <span className="px-10 py-4 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-xl hover:bg-gray-800 dark:hover:bg-gray-200 cursor-pointer inline-block font-semibold text-lg shadow-lg hover:shadow-xl btn-primary">
                    {currentT.choose}
                  </span>
                </label>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-6">{currentT.format}</p>
              </div>
            ) : (
              <div className="space-y-6">
                <div className="relative rounded-2xl overflow-hidden border-2 border-gray-200 dark:border-gray-600 shadow-lg">
                  <img 
                    src={preview} 
                    alt="X-Ray Preview" 
                ...
                <div className="bg-gray-50 dark:bg-gray-700 rounded-2xl p-6 flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900 rounded-xl flex items-center justify-center">
                      <Image className="w-6 h-6 text-blue-600 dark:text-blue-300" />
                    </div>
                    <div>
                ...
                <div className="flex space-x-4 pt-4">
                  <label className="flex-1">
                    <input
                      ...
                      className="hidden"
                    />
                    <span className={`block w-full py-4 bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 cursor-pointer text-center font-semibold text-lg transition ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}>
                      {currentT.change}
                    </span>
                  </label>
                  <button
                    ...
                    disabled={loading}
                    className="flex-1 py-4 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-xl hover:bg-gray-800 dark:hover:bg-gray-200 font-semibold text-lg shadow-lg hover:shadow-xl btn-primary flex justify-center items-center disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                    {loading ? (
                      <>
          ...
          <div className="mt-8 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/30 dark:to-cyan-900/30 border-2 border-blue-200 dark:border-blue-800 rounded-2xl p-8 animate-fade-in stagger-1">
            <h4 className="font-bold text-gray-900 dark:text-white text-xl mb-4 flex items-center space-x-2">
              <Image className="w-6 h-6 text-blue-600 dark:text-blue-400" />
              <span>{currentT.guidelines}</span>
            </h4>
            <ul className="space-y-3 text-gray-700 dark:text-gray-300">
              <li className="flex items-start space-x-3">
                <Check className="w-5 h-5 text-blue-600 dark:text-blue-400 mt-0.5 flex-shrink-0" strokeWidth={2.5} />
              ...
              <li className="flex items-start space-x-3">
                <AlertTriangle className="w-5 h-5 text-blue-600 dark:text-blue-400 mt-0.5 flex-shrink-0" strokeWidth={2.5} />
